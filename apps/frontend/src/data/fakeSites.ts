...
export const fakeSites: Site[] = [
  // ── 부산: running + standby → 지역 색 = 주황(standby) ────────────────────
  {
    id: "busan-smartgrid",
    name: "부산스마트그리드",
    region: "부산",
    ...
    installations: [
      {
        ...
        label: "해운대 전력실",
        capacity: 500,
        coordinates: [129.1604, 35.1631],
        device: {
          installationId: "PSVG-BUSAN01",
          status: "running",
      ...
      },
      {
        ...
        label: "사하 변전실",
        capacity: 300,
        coordinates: [128.9786, 35.0995],
        device: {
          installationId: "PSVG-BUSAN02",
          status: "standby",
          lastSeenAt: new Date(Date.now() - 1000 * 60 * 22).toISOString(),
  ...
  // ── 대전: standby + running + fault → 지역 색 = 빨간(fault) ──────────────
  {
    id: "daejeon-power",
    name: "대전전력관리",
    region: "대전",
    ...
    installations: [
      {
        ...
        label: "유성 변전실",
        capacity: 300,
        coordinates: [127.3445, 36.3622],
        device: {
          installationId: "PSVG-DAEJEON01",
          status: "standby",
      ...
      },
      {
        ...
        label: "동구 전력실",
        capacity: 400,
        coordinates: [127.4560, 36.3090],
        device: {
          installationId: "PSVG-DAEJEON02",
          status: "running",
          lastSeenAt: new Date(Date.now() - 1000 * 60 * 7).toISOString(),
          moduleStatus: [2, 2, 2, 2, 2, 2],
          numOfMods: 6,
      ...
      },
      {
        ...
        label: "서구 변전실",
        capacity: 350,
        coordinates: [127.3836, 36.3500],
        device: {
          installationId: "PSVG-DAEJEON03",
          status: "fault",
          lastSeenAt: new Date(Date.now() - 1000 * 60 * 72).toISOString(),
  ...
  // ── 경상북도: fault + running + standby → 지역 색 = 빨간(fault) ──────────
  {
    id: "gyeongbuk-energy",
    name: "경북에너지",
    region: "경상북도",
    ...
    installations: [
      {
        ...
        label: "구미 주전력실",
        capacity: 750,
        coordinates: [128.3440, 36.1194],
        device: {
          installationId: "PSVG-GYBK01",
          status: "fault",
      ...
      },
      {
        ...
        label: "경주 변전실",
        capacity: 400,
        coordinates: [129.2270, 35.8562],
        device: {
          installationId: "PSVG-GYBK03",
          status: "standby",
  ...
  // ── 서울: running + standby + fault → 지역 색 = 빨간(fault) ─────────────
  {
    id: "seoul-multisite",
    name: "서울복합전력",
    region: "서울",
    ...
    installations: [
      {
        ...
        label: "종로 변전실",
        capacity: 400,
        coordinates: [126.9784, 37.5705],
        device: {
          installationId: "PSVG-SEOUL01",
          status: "running",
      ...
      },
      {
        ...
        label: "마포 변전실",
        capacity: 300,
        coordinates: [126.9010, 37.5560],
        device: {
          installationId: "PSVG-SEOUL02",
          status: "standby",
      ...
      },
      {
        ...
        label: "강남 변전실",
        capacity: 600,
        coordinates: [127.0479, 37.5172],
        device: {
          installationId: "PSVG-SEOUL03",
          status: "fault",
          lastSeenAt: new Date(Date.now() - 1000 * 60 * 58).toISOString(),
          moduleStatus: [2, 3, 3, 2, 3, 2],
          numOfMods: 6,
  ...
  // ── 전북: running + standby → 지역 색 = 주황(standby) ───────────────────
  {
    id: "jeonbuk-electric",
    name: "전북전기설비",
    region: "전북특별자치도",
    ...
    installations: [
      {
        ...
        label: "전주 변전실",
        capacity: 450,
        coordinates: [127.1465, 35.8242],
        device: {
          installationId: "PSVG-JEONBUK01",
          status: "running",
      ...
      },
      {
        ...
        label: "익산 변전실",
        capacity: 350,
        coordinates: [126.9547, 35.9483],
        device: {
          installationId: "PSVG-JEONBUK02",
          status: "standby",
